...
@EnableMongoRepositories("com.GroceryOrderingSystem.repository")
@SuppressWarnings("SpringJavaAutowiringInspection")
public class Server_app implements CommandLineRunner {
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication.run(Server_app.class, args);
        filing_logging();
