...
public class Server_app2 implements CommandLineRunner {
    ...
    private static Logger LOGGER = Logger.getLogger(String.valueOf(Server_app2.class));
    ...
    static                                //static block for formatter output and logger
    {
        ...
        lgm = Logger.getLogger((Server_app2.class.getClass().getName()));
    }

    public static void filing_logging() throws Exception{      //handling output of logger into a file

        fhl = new FileHandler("./Server_app2.log");
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication.run(Server_app2.class, args);
        filing_logging();
